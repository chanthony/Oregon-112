...
def homeworkGrades(data,hwGrade):
    #to do: homework grade impact based on distance from homework grade
    for character in data.characterList:
...
def victoryRedrawAll(canvas,data):
    canvas.create_text(data.width/2,data.height/2 - 100,
                        text = "Congratulations, you survived 112!",
                        fill = "white",font="Arial 32")
    canvas.create_text(data.width/2,data.height/2 + 20,
                        text = "Stay tuned for Oregon 122",
...
def failureRedrawAll(canvas,data):
    canvas.create_text(data.width/2,data.height/2 - 100,
                    text = "You did not survive 112",
                    fill = "white",font="Arial 32")
    canvas.create_text(data.width/2,data.height/2 + 20,
                    text = "See you next semester in Oregon 112",
                    fill = "white",font="Arial 24")
