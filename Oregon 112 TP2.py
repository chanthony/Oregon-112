...
#To-Do
#link to run function source
#add minigame randomly after quizzes- shooter?
#improve traveling graphics
#
...
###################################
#Run function borrowed from 15-112 schedule linktowebsite
###################################
